...
const RESOURCES: ResourceCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Frame before content', detail: '国 : outer frame 口, then 玉, then bottom bar' },
      { title: 'Left diagonal before right', detail: '人 : 丿 then 乀' },
  ...
  // ── Vocabulary
  {
    ...
    href: '/courses',
    items: [
      { title: 'Greetings & politeness', detail: '你好, 谢谢, 对不起, 没关系, 请...' },
      { title: 'Family', detail: '爸爸, 妈妈, 哥哥, 姐姐, 儿子, 女儿...' },
      { title: 'Food & drinks', detail: '米饭, 面条, 茶, 咖啡, 水果...' },
      { title: 'Transportation', detail: '飞机, 火车, 地铁, 出租车, 公共汽车...' },
      { title: 'Colors & numbers', detail: '红, 蓝, 绿, 一到十, 百, 千, 万...' },
    ],
  },
  {
    id: 'measure-words',
  ...
  // ── Culture
  {
    ...
    items: [
      ...
      { title: 'Handwriting practice', detail: 'Practicing handwriting helps memorize characters 3x faster' },
