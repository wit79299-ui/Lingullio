  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-navy-50 mb-6">
        <RefreshCw className="h-8 w-8 text-navy-400" />
      </div>
      <h1 className="text-2xl font-bold text-navy-900 mb-2">{t('revisions')}</h1>
      <p className="text-navy-400 max-w-md">
        Votre systeme de revision intelligente par repetition espacee. Cartes flash, exercices cibles et rappels automatiques.
      </p>
