...
const CHALLENGE_BANK: ChallengeQuestion[] = [
  { id: 'dc-1', type: 'translate_to_english', prompt: '\u4f60\u597d', options: ['Bonjour', 'Au revoir', 'Merci', 'Excusez-moi'], correctIndex: 0, explanation: '\u4f60\u597d (n\u01d0 h\u01ceo) is the most common greeting in Chinese.', difficulty: 1, hskLevel: 1 },
  { id: 'dc-2', type: 'pinyin_match', prompt: 'What is the pinyin of \u8c22\u8c22 ?', options: ['xi\u00e8 xie', 'x\u01d0 huan', 'xi\u01ceo x\u012bn', 'xu\u00e9 x\u00ed'], correctIndex: 0, explanation: '\u8c22\u8c22 (xi\u00e8 xie) means "merci".', difficulty: 1, hskLevel: 1 },
  { id: 'dc-3', type: 'character_meaning', prompt: 'What does the character .* mean \u5927 ?', options: ['Grand', 'Petit', 'Moyen', 'Haut'], correctIndex: 0, explanation: '\u5927 (d\u00e0) means "grand". Its opposite is \u5c0f (xi\u01ceo) "petit".', difficulty: 1, hskLevel: 1 },
  { id: 'dc-4', type: 'translate_to_chinese', prompt: 'How do you say "je" in Chinese?', options: ['\u6211', '\u4f60', '\u4ed6', '\u5979'], correctIndex: 0, explanation: '\u6211 (w\u01d2) = je/moi. \u4f60 (n\u01d0) = tu. \u4ed6/\u5979 (t\u0101) = il/elle.', difficulty: 1, hskLevel: 1 },
  { id: 'dc-5', type: 'fill_blank', prompt: '\u6211___\u5b66\u751f\u3002 (Je suis etudiant)', options: ['\u662f', '\u6709', '\u5728', '\u8981'], correctIndex: 0, explanation: '\u662f (sh\u00ec) = etre. Structure: Subject + \u662f + Nom', difficulty: 1, hskLevel: 1 },
  { id: 'dc-6', type: 'translate_to_english', prompt: '\u6211\u559c\u6b22\u5403\u4e2d\u56fd\u83dc', options: ['J\'aime manger la cuisine chinoise', 'Je veux acheter des vetements', 'J\'etudie le chinois', 'Je vais en Chine'], correctIndex: 0, explanation: '\u559c\u6b22 (x\u01d0 huan) = aimer. \u5403 (ch\u012b) = manger. \u4e2d\u56fd\u83dc (zh\u014dng gu\u00f3 c\u00e0i) = cuisine chinoise.', difficulty: 2, hskLevel: 1 },
  { id: 'dc-7', type: 'pinyin_match', prompt: 'How do you pronounce \u5b66\u6821 (ecole) ?', options: ['xu\u00e9 xi\u00e0o', 'xu\u00e9 sh\u0113ng', 'xi\u01ceo xu\u00e9', 'x\u01d0 huan'], correctIndex: 0, explanation: '\u5b66\u6821 (xu\u00e9 xi\u00e0o) = ecole.', difficulty: 2, hskLevel: 1 },
  { id: 'dc-8', type: 'fill_blank', prompt: '\u4ed6___\u5728\u770b\u4e66\u3002 (Il est en train de lire)', options: ['\u6b63', '\u5df2\u7ecf', '\u8fd8', '\u5c31'], correctIndex: 0, explanation: '\u6b63\u5728 (zh\u00e8ng z\u00e0i) indicates an ongoing action.', difficulty: 2, hskLevel: 2 },
  { id: 'dc-9', type: 'translate_to_english', prompt: '\u867d\u7136\u5f88\u7d2f\uff0c\u4f46\u662f\u5f88\u5f00\u5fc3', options: ['Bien que fatigue, je suis content', 'Parce que je suis fatigue, je dors', 'Si je suis fatigue, je me repose', 'Quand je suis fatigue, je suis triste'], correctIndex: 0, explanation: '\u867d\u7136...\u4f46\u662f... (su\u012b r\u00e1n...d\u00e0n sh\u00ec...) = bien que...mais...', difficulty: 2, hskLevel: 2 },
  { id: 'dc-10', type: 'character_meaning', prompt: 'What does \u5feb mean?', options: ['Rapide', 'Lent', 'Facile', 'Difficile'], correctIndex: 0, explanation: '\u5feb (ku\u00e0i) = rapide. Its opposite is \u6162 (m\u00e0n) = lent.', difficulty: 1, hskLevel: 2 },
  ...
  { id: 'dc-12', type: 'translate_to_english', prompt: '\u4ed6\u628a\u4e66\u653e\u5728\u684c\u5b50\u4e0a\u4e86', options: ['Il a pose le livre sur la table', 'Il a pris le livre de la table', 'Il lit un livre a table', 'Le livre est sous la table'], correctIndex: 0, explanation: '\u628a (b\u01ce) : structure ba. \u653e = poser, \u684c\u5b50 = table.', difficulty: 3, hskLevel: 3 },
  { id: 'dc-13', type: 'translate_to_english', prompt: '\u8fd9\u4ef6\u4e8b\u503c\u5f97\u6211\u4eec\u8ba4\u771f\u8003\u8651', options: ['Cette affaire merite qu\'on y reflechisse serieusement', 'Cette affaire n\'est pas importante', 'On a deja reflechi a cette affaire', 'Cette affaire est trop compliquee'], correctIndex: 0, explanation: '\u503c\u5f97 (zh\u00ed de) = meriter. \u8ba4\u771f (r\u00e8n zh\u0113n) = serieux. \u8003\u8651 (k\u01ceo l\u01dc) = reflechir.', difficulty: 3, hskLevel: 4 },
  { id: 'dc-14', type: 'character_meaning', prompt: 'What does \u5f71\u54cd mean?', options: ['Influence', 'Image', 'Ombre', 'Emotion'], correctIndex: 0, explanation: '\u5f71\u54cd (y\u01d0ng xi\u01ceng) = influence/impact.', difficulty: 3, hskLevel: 4 },
