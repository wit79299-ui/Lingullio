...
interface ChallengeQuestion {
  id: string;
  type: 'translate_to_chinese' | 'translate_to_english' | 'pinyin_match' | 'character_meaning' | 'fill_blank';
  prompt: string;
  options: string[];
  correctIndex: number;
  explanation: string;
...
const CHALLENGE_BANK: ChallengeQuestion[] = [
  { id: 'dc-1', type: 'translate_to_english', prompt: '\u4f60\u597d', options: ['Hello', 'Goodbye', 'Thank you', 'Excuse me'], correctIndex: 0, explanation: '\u4f60\u597d (n\u01d0 h\u01ceo) is the most common greeting in Chinese.', difficulty: 1, hskLevel: 1 },
  { id: 'dc-2', type: 'pinyin_match', prompt: 'What is the pinyin of \u8c22\u8c22 ?', options: ['xi\u00e8 xie', 'x\u01d0 huan', 'xi\u01ceo x\u012bn', 'xu\u00e9 x\u00ed'], correctIndex: 0, explanation: '\u8c22\u8c22 (xi\u00e8 xie) means "thank you".', difficulty: 1, hskLevel: 1 },
  { id: 'dc-3', type: 'character_meaning', prompt: 'What does the character .* mean \u5927 ?', options: ['Big', 'Small', 'Medium', 'Tall'], correctIndex: 0, explanation: '\u5927 (d\u00e0) means "big". Its opposite is \u5c0f (xi\u01ceo) "small".', difficulty: 1, hskLevel: 1 },
  { id: 'dc-4', type: 'translate_to_chinese', prompt: 'How do you say "I" in Chinese?', options: ['\u6211', '\u4f60', '\u4ed6', '\u5979'], correctIndex: 0, explanation: '\u6211 (w\u01d2) = I/me. \u4f60 (n\u01d0) = you. \u4ed6/\u5979 (t\u0101) = he/she.', difficulty: 1, hskLevel: 1 },
  { id: 'dc-5', type: 'fill_blank', prompt: '\u6211___\u5b66\u751f\u3002 (I am a student)', options: ['\u662f', '\u6709', '\u5728', '\u8981'], correctIndex: 0, explanation: '\u662f (sh\u00ec) = to be. Structure: Subject + \u662f + Noun', difficulty: 1, hskLevel: 1 },
  { id: 'dc-6', type: 'translate_to_english', prompt: '\u6211\u559c\u6b22\u5403\u4e2d\u56fd\u83dc', options: ['I like eating Chinese food', 'I want to buy clothes', 'I study Chinese', 'I am going to China'], correctIndex: 0, explanation: '\u559c\u6b22 (x\u01d0 huan) = to like. \u5403 (ch\u012b) = to eat. \u4e2d\u56fd\u83dc (zh\u014dng gu\u00f3 c\u00e0i) = Chinese food.', difficulty: 2, hskLevel: 1 },
  { id: 'dc-7', type: 'pinyin_match', prompt: 'How do you pronounce \u5b66\u6821 (school) ?', options: ['xu\u00e9 xi\u00e0o', 'xu\u00e9 sh\u0113ng', 'xi\u01ceo xu\u00e9', 'x\u01d0 huan'], correctIndex: 0, explanation: '\u5b66\u6821 (xu\u00e9 xi\u00e0o) = school.', difficulty: 2, hskLevel: 1 },
  { id: 'dc-8', type: 'fill_blank', prompt: '\u4ed6___\u5728\u770b\u4e66\u3002 (He is reading)', options: ['\u6b63', '\u5df2\u7ecf', '\u8fd8', '\u5c31'], correctIndex: 0, explanation: '\u6b63\u5728 (zh\u00e8ng z\u00e0i) indicates an ongoing action.', difficulty: 2, hskLevel: 2 },
  { id: 'dc-9', type: 'translate_to_english', prompt: '\u867d\u7136\u5f88\u7d2f\uff0c\u4f46\u662f\u5f88\u5f00\u5fc3', options: ['Although tired, I am happy', 'Because I am tired, I sleep', 'If I am tired, I rest', 'When I am tired, I am sad'], correctIndex: 0, explanation: '\u867d\u7136...\u4f46\u662f... (su\u012b r\u00e1n...d\u00e0n sh\u00ec...) = although...but...', difficulty: 2, hskLevel: 2 },
  { id: 'dc-10', type: 'character_meaning', prompt: 'What does \u5feb mean?', options: ['Fast', 'Slow', 'Easy', 'Difficult'], correctIndex: 0, explanation: '\u5feb (ku\u00e0i) = fast. Its opposite is \u6162 (m\u00e0n) = slow.', difficulty: 1, hskLevel: 2 },
  { id: 'dc-11', type: 'fill_blank', prompt: '\u4f60___\u53bb\u8fc7\u4e2d\u56fd\u5417\uff1f (Have you ever been to China?)', options: ['\u6709\u6ca1\u6709', '\u662f\u4e0d\u662f', '\u4f1a\u4e0d\u4f1a', '\u8981\u4e0d\u8981'], correctIndex: 0, explanation: '\u6709\u6ca1\u6709 + V + \u8fc7 = interrogative form for "have you ever done".', difficulty: 3, hskLevel: 3 },
  { id: 'dc-12', type: 'translate_to_english', prompt: '\u4ed6\u628a\u4e66\u653e\u5728\u684c\u5b50\u4e0a\u4e86', options: ['He put the book on the table', 'He took the book from the table', 'He reads a book at the table', 'The book is under the table'], correctIndex: 0, explanation: '\u628a (b\u01ce) : ba structure. \u653e = to put, \u684c\u5b50 = table.', difficulty: 3, hskLevel: 3 },
  { id: 'dc-13', type: 'translate_to_english', prompt: '\u8fd9\u4ef6\u4e8b\u503c\u5f97\u6211\u4eec\u8ba4\u771f\u8003\u8651', options: ['Cette affaire merite qu\'on y reflechisse serieusement', 'Cette affaire n\'est pas importante', 'On a deja reflechi a cette affaire', 'Cette affaire est trop compliquee'], correctIndex: 0, explanation: '\u503c\u5f97 (zh\u00ed de) = to deserve. \u8ba4\u771f (r\u00e8n zh\u0113n) = serious. \u8003\u8651 (k\u01ceo l\u01dc) = to consider.', difficulty: 3, hskLevel: 4 },
  { id: 'dc-14', type: 'character_meaning', prompt: 'What does \u5f71\u54cd mean?', options: ['Influence', 'Image', 'Shadow', 'Emotion'], correctIndex: 0, explanation: '\u5f71\u54cd (y\u01d0ng xi\u01ceng) = influence/impact.', difficulty: 3, hskLevel: 4 },
  { id: 'dc-15', type: 'fill_blank', prompt: '___\u4f60\u4e0d\u6765\uff0c\u6211\u5c31\u4e00\u4e2a\u4eba\u53bb\u3002 (Si tu ne viens pas, j\'irai seul)', options: ['\u8981\u662f', '\u867d\u7136', '\u56e0\u4e3a', '\u800c\u4e14'], correctIndex: 0, explanation: '\u8981\u662f (y\u00e0o sh\u00ec) = if (conditional). Structure : \u8981\u662f A\uff0c\u5c31 B.', difficulty: 2, hskLevel: 3 },
];
...
function generateKMQuestion(item: KnowledgeItem, type: ChallengeQuestion['type'], allItems: KnowledgeItem[]): ChallengeQuestion | null {
  ...
  if (type === 'pinyin_match') {
    ...
    return {
      ...
      type: 'pinyin_match',
      prompt: `What is the pinyin of ${item.display} ?`,
      options: options.slice(0, 4),
      correctIndex: correctIdx,
      explanation: `${item.display} (${item.pinyin}) = ${item.meaning}`,
      difficulty: (item.mastery === 'mastered' ? 1 : item.mastery === 'familiar' ? 2 : 3) as 1 | 2 | 3,
...
function getDailyChallengeQuestions(count: number = 3): ChallengeQuestion[] {
  ...
  if (allItems.length >= 8) {
    ...
    const questionTypes: ChallengeQuestion['type'][] = ['translate_to_english', 'pinyin_match', 'character_meaning'];
...
export function DailyChallenge({ className }: { className?: string }) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/80">
                ...
                {isAdaptive && <span className="ml-1 opacity-80">· adapted to your level</span>}
              </p>
            </div>
            <div className="ml-auto text-right">
              <p className="text-xs font-bold">+{XP_CONFIG.daily_goal_complete} XP</p>
              <p className="text-[10px] text-white/60">possible bonus</p>
            </div>
          </div>
        </div>
        <CardContent className="p-4">
          {isAdaptive && (
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-teal-50 border border-teal-100 mb-3">
              ...
              <p className="text-[11px] text-teal-700">Questions generated from your Living Memory</p>
            </div>
          )}
      ...
      <Card className={cn('!py-0 overflow-hidden', className)}>
        <div className={cn(
          ...
          <p className="text-sm font-semibold mt-1">
            {isPerfect ? 'Perfect challenge!' : pct >= 60 ? 'Well done!' : 'Keep practicing!'}
          </p>
          {xpEarned > 0 && (
      ...
      <Card className={cn('!py-0 overflow-hidden', className)}>
        <div className="bg-gradient-to-r from-emerald-500 to-teal-500 px-5 py-4 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-sm">Daily Challenge termine !</h3>
              <p className="text-[11px] text-white/80">Come back tomorrow for a new challenge</p>
            </div>
          </div>
        </div>
      </Card>
  ...
  const typeLabels: Record<string, string> = {
    ...
    translate_to_french: '\ud83c\uddeb\ud83c\uddf7 Translate to English',
    pinyin_match: '\ud83d\udcd6 Pinyin',
      ...
      <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-5 py-3 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold">Daily Challenge</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        {!isAnswered ? (
          ...
          <Button onClick={handleNext} variant="teal" size="lg" className="w-full">
            {currentIdx < questions.length - 1 ? (
              ...
              <>See results <Star className="h-4 w-4" /></>
            )}
          </Button>
        )}
      </CardContent>
    ...
    <div className={cn(
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold text-navy-900">
          {hasActivity ? 'Challenge completed!' : 'Daily Challenge'}
        </p>
